...
namespace Nop.Services.Customers
{
    ...
    public partial interface ICustomerService
    {
        ...
        IPagedList<Customer> GetAllCustomers2(DateTime? createdFromUtc = null, DateTime? createdToUtc = null,
            int affiliateId = 0, int vendorId = 0, int[] customerRoleIds = null,
            string email = null, string username = null, string firstName = null, string lastName = null,
            int dayOfBirth = 0, int monthOfBirth = 0, string id = null,
            string company = null, string phone = null, string zipPostalCode = null, string ipAddress = null, int pageIndex = 0, int pageSize = int.MaxValue, 
            bool getOnlyTotalCount = false, bool itemsInCart=false, int customerStatus = 0, string city=null, string country = null, string salesmanid=null);
        ...
        IPagedList<Customer> GetOnlineCustomersForSalesMan(DateTime lastActivityFromUtc, int salesmanId,
            int[] customerRoleIds, int pageIndex = 0, int pageSize = int.MaxValue);
        ...
        IList<Customer> GetWeclappNewCustomers(int noOfCustomers, DateTime timeAfter, bool retryFailed = false);
        ...
        CustomerCommission CalculateSalemanCommission(int salemanId, DateTime month);
        CustomerCommission ReCalculateSalemanCommission(int commissionId);
        CustomerCommission GetSalemanCommissionByMonth(int salemanId, DateTime month);
        CustomerCommission GetSalemanCommissionById(int id);
        IPagedList<CustomerCommission> GetSalemanCommissions(int salemanId, int pageIndex = 0, int pageSize = int.MaxValue);
        ...
        List<Customer> GetAllCustomerByRoles(List<int> customerRoles);
        ...
        List<CustomerRole> GetCustomerRolesByName(string systemName);
