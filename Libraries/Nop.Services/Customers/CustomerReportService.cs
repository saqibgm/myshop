...
namespace Nop.Services.Customers
{
    ...
    public partial class CustomerReportService : ICustomerReportService
    {
            ...
            int pageIndex = 0, int pageSize = 214748364)
        {
            ...
            var custQuery = _customerRepository.Table;
            var query1 = from c in custQuery
            ...
            if (salesmanid != 0)
            {
                query1 = query1.Where(a=>a.c.TeamMemberOfSaleman==salesmanid);
            }
            ...
            return new PagedList<BestCustomerReportLine>(tmp.Select(x => new BestCustomerReportLine
            {
                ...
                pageIndex, pageSize, tmp.TotalCount);
        }
