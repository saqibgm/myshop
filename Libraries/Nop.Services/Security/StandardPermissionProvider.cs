...
namespace Nop.Services.Security
{
    ...
    public partial class StandardPermissionProvider : IPermissionProvider
    {
        ...
        public static readonly PermissionRecord ManageProductBulkUpdate = new PermissionRecord { Name = "Admin area. Manage Product Bulk Update", SystemName = "ManageProductBulkUpdate", Category = "Catalog" };
        ...
        public static readonly PermissionRecord ManageCustomerRoles = new PermissionRecord { Name = "Admin area. Manage Customers Role", SystemName = "ManageCustomerRoles", Category = "Customers" };
        public static readonly PermissionRecord ManageCustomerOnline = new PermissionRecord { Name = "Admin area. Manage Online Customers", SystemName = "ManageCustomerOnline", Category = "Customers" };
        public static readonly PermissionRecord ManageCustomerGDPR = new PermissionRecord { Name = "Admin area. Manage Customer GDPR", SystemName = "ManageCustomerGDPR", Category = "Customers" };
        ...
        public static readonly PermissionRecord ManageOrderShipment = new PermissionRecord { Name = "Admin area. Manage Order Shipment", SystemName = "ManageOrderShipment", Category = "Orders" };
        ...
        public static readonly PermissionRecord OrderCountryReport = new PermissionRecord { Name = "Admin area. Access order Saleman Commission report", SystemName = "OrderCountryReport", Category = "Orders" };
        public static readonly PermissionRecord OrderSalemanCommissionReport = new PermissionRecord { Name = "Admin area. Access order country report", SystemName = "OrderSalemanCommissionReport", Category = "Orders" };
        ...
        public virtual IEnumerable<PermissionRecord> GetPermissions()
        {
            return new[] 
            {
                ...
                ManageProductTags,
                ManageProductBulkUpdate,
                ManageAttributes,
                ManageCustomers,
                ManageCustomerRoles,
                ManageCustomerOnline,
                ManageCustomerGDPR,
                ManageVendors,
                ManageCurrentCarts,
                ManageOrders,
