...
namespace Nop.Services.Orders
{
    ...
    public partial interface IOrderProcessingService
    {
        ...
        /// Places Quick order
        /// </summary>
        /// <param name="processPaymentRequest">Process payment request, Order Items</param>
        /// <returns>Place order result</returns>
        PlaceOrderResult PlaceQuickOrder(ProcessPaymentRequest processPaymentRequest,  List<OrderItem> OrderItems = null, OrderStatus orderStatus = OrderStatus.Pending);
        /// <summary>
        /// Update Quick order
        /// </summary>
        /// <param name="order">Process payment request, Order Items</param>
        /// <param name="OrderItems"> Order Items</param>
        /// /// <param name="OldStatus"> Old Status of Order</param>
        /// <returns>Place order result</returns>
        PlaceOrderResult UpdateQuickOrder(Order order, List<OrderItem> OrderItems = null, OrderStatus OldStatus = OrderStatus.Processing);
        ...
        void MarkOrderAsUnPaid(Order order);
