...
namespace Nop.Services.Orders
{
    ...
    public partial interface IOrderService
    {
        ...
        IList<Order> GetWeclappNewOrders(int noOfOrders, DateTime timeAfter, bool retryFailed = false);
        /// <summary>
        /// Gets an order
        /// </summary>
        ...
        List<CustomerProductDetailsModel> GetCustomerProducts(int customerId);
        /// <summary>
        /// Deletes an order
        /// </summary>
        ...
        IPagedList<Order> SearchOrders2(int storeId = 0,
        ...
        void UpdateOrders(IList<Order> orders);
        void UpdateOrder(Order order, bool reCalProfit);
        /// <summary>
        ...
        List<OrderItem> GetLastPricesByCustomer(int customerId, int[] productIDs = null);
