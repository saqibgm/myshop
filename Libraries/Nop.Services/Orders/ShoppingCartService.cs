...
namespace Nop.Services.Orders
{
    ...
    public partial class ShoppingCartService : IShoppingCartService
    {
        ...
        {
            return AddToCart2(customer, product, shoppingCartType, storeId, attributesXml, customerEnteredPrice, 
                              rentalStartDate, rentalEndDate, quantity, addRequiredProducts, false);
        }
        public virtual IList<string> AddToCart2(Customer customer, Product product,
            ShoppingCartType shoppingCartType, int storeId, string attributesXml = null,
            decimal customerEnteredPrice = decimal.Zero,
            DateTime? rentalStartDate = null, DateTime? rentalEndDate = null,
            int quantity = 1, bool addRequiredProducts = true, bool isQuickOrder = false)
        {
            if (customer == null)
                throw new ArgumentNullException(nameof(customer));
            ...
            if (shoppingCartItem != null)
            {
                ...
                _customerService.UpdateCustomer(customer);
                shoppingCartItem.IsQuickOrder = isQuickOrder;
                //event notification
