...
namespace Nop.Services.Orders
{
    ...
    public partial interface IOrderReportService
    {
        ...
        /// Get "order by country" report
        /// </summary>
        /// <param name="storeId">Store identifier; 0 to GetCommissionReport</param>
        /// <param name="os">Order status</param>
        /// <param name="ps">Payment status</param>
        /// <param name="ss">Shipping status</param>
        /// <param name="startTimeUtc">Start date</param>
        /// <param name="endTimeUtc">End date</param>
        /// <returns>Result</returns>
        IList<OrderByCommissionModelReportLine> GetCommissionReport(int storeId = 0,int? salemanId = 0, OrderStatus? os = null,
            PaymentStatus? ps = null, 
            DateTime? startTimeUtc = null, DateTime? endTimeUtc = null);
        /// <summary>
        /// Get "Profit Report" report
        /// </summary>
        /// <param name="storeId">Store identifier; 0 to GetCustomerProfitReport</param>        
        /// <param name="ps">Only Paid</param>       
        /// <param name="startTimeUtc">Start date</param>
        /// <param name="endTimeUtc">End date</param>
        /// <returns>Result</returns>
        IList<OrderByCustomerProfitReportLine> GetCustomerProfitReport(int storeId, int CustomerId, int OrderStatusId, string InvoiceNo, DateTime? startTimeUtc, DateTime? endTimeUtc);
        /// <summary>
        /// Get "Salement Statistical Data" report
        /// </summary>
        /// <param name="storeId">Store identifier; 0 to GetSalemanStatisticsReport</param>        
        /// <param name="ps">Oly Paid</param>       
        /// <param name="startTimeUtc">Start date</param>
        /// <param name="endTimeUtc">End date</param>
        /// <returns>Result</returns>
        IList<OrderBySalemanStatisticsReportLine> GetSalemanStatisticsReport(int storeId, int SalemanId, DateTime startTimeUtc, DateTime endTimeUtc);
        ...
        OrderAverageReportLine GetOrderAverageReportLine2(int storeId = 0, int vendorId = 0, int productId = 0,
            int warehouseId = 0, int billingCountryId = 0, int orderId = 0, string paymentMethodSystemName = null,
            List<int> osIds = null, List<int> psIds = null, List<int> ssIds = null,
            DateTime? startTimeUtc = null, DateTime? endTimeUtc = null,
        ...
        OrderAverageReportLineSummary OrderAverageReport2(int storeId, OrderStatus os, int salesmanId = 0);
        ...
        IPagedList<BestsellersReportLine> BestSellersReport2(
            int categoryId = 0, int manufacturerId = 0,
            int storeId = 0, int vendorId = 0,
            DateTime? createdFromUtc = null, DateTime? createdToUtc = null,
            OrderStatus? os = null, PaymentStatus? ps = null, ShippingStatus? ss = null,
        ...
        decimal ProfitReport(int storeId = 0, int vendorId = 0, int productId = 0,
            ...
            DateTime? startTimeUtc = null, DateTime? endTimeUtc = null,
            string billingPhone = null, string billingEmail = null, string billingLastName = "", string orderNotes = null);
        decimal NetProfitReport(int storeId = 0, int vendorId = 0, int productId = 0,
            int warehouseId = 0, int billingCountryId = 0, int orderId = 0, string paymentMethodSystemName = null,
            List<int> osIds = null, List<int> psIds = null, List<int> ssIds = null,
            DateTime? startTimeUtc = null, DateTime? endTimeUtc = null,
            string billingPhone = null, string billingEmail = null, string billingLastName = "", string orderNotes = null);
        decimal ProfitReport(List<Order> query, List<OrderItem> pItems, int OrderId = 0, List<int> psIds = null);
    }
}
