...
namespace Nop.Services.Catalog
{
    ...
    public partial interface IProductService
    {
        ...
        IList<Product> GetWeclappNewProducts(int noOfProducts, DateTime timeAfter, bool retryFailed = false);
        ...
        /// <param name="articleNo">articleNo
        /// <param name="storeId">Store identifier; 0 to load all records</param>
        ...
        /// </param>
        /// <returns>Products</returns>
        IPagedList<Product> SearchProducts2(
            int pageIndex = 0,
            ...
            bool? overrideNewStockComing = null
            );
        ...
        List<TierPrice> GeCustomerTierPrices(Customer customer);
