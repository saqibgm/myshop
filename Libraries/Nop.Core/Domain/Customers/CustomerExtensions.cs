...
namespace Nop.Core.Domain.Customers
{
    ...
    public static class CustomerExtensions
    {
        ...
        public static bool IsSaleman(this Customer customer, bool onlyActiveCustomerRoles = true)
        {
            return IsInCustomerRole(customer, NopCustomerDefaults.SalemanRoleName, onlyActiveCustomerRoles);
        }

        public static bool IsCataloguer(this Customer customer, bool onlyActiveCustomerRoles = true)
        {
            return IsInCustomerRole(customer, NopCustomerDefaults.CataloguerRoleName, onlyActiveCustomerRoles);
        }
        ...
        public static bool IsCustomer(this Customer customer, bool onlyActiveCustomerRoles = true)
        {
            return IsRegistered(customer, onlyActiveCustomerRoles) && 
                !IsUnApproved(customer, onlyActiveCustomerRoles) && 
                !IsAdmin(customer, onlyActiveCustomerRoles) && 
        ...
        public static bool IsCustomer(this Customer customer)
        {
            return IsRegistered(customer, true) &&
                !IsUnApproved(customer, true) &&
                !IsAdmin(customer, true) &&
                !IsManager(customer, true) &&
                !IsVendor(customer, true) &&
                !IsSaleman(customer, true);
        }
        ...
        public static bool IsUnApproved(this Customer customer, bool onlyActiveCustomerRoles = true)
        {
