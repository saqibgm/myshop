...
namespace Nop.Core.Domain.Customers
{
    ...
    public static partial class NopCustomerDefaults
    {
        ...
        /// <summary>
        /// Gets a system name of 'Manager' customer role
        /// </summary>
        public static string ManagerRoleName => "Manager";
        /// <summary>
        /// Gets a system name of 'Saleman' customer role
        /// </summary>
        public static string SalemanRoleName => "Saleman";
        public static string CataloguerRoleName => "Cataloguer";
        public static string IncompleteRoleName => "IncompleteRoleName";
        /// <summary>
        /// Gets a system name of 'Saleman' customer role
        /// </summary>
        ...
        /// <summary>
        /// Gets a name of generic attribute to store the value of 'BusinessCertIdAttribute'
        /// </summary>
        public static string BusinessCertIdAttribute => "BusinessCertIdAttribute";
        /// <summary>
        ...
        public static string BusinessCertId => "BusinessCertId";
        #endregion
    }
}