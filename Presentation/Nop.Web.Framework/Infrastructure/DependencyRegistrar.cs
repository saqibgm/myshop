...
namespace Nop.Web.Framework.Infrastructure
{
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder, NopConfig config)
        {
            ...
            builder.RegisterType<CustomerCommission>().As<BaseEntity>().InstancePerLifetimeScope();
            ...
            builder.RegisterType<ExportLogService>().As<IExportLogService>().InstancePerLifetimeScope();
            ...
            builder.RegisterType<WeclappIntegrationService>().As<IWeclappIntegrationService>().InstancePerLifetimeScope();
            builder.RegisterType<WeclappSyncTask>().As<IWeclappSyncTask>().InstancePerLifetimeScope();
