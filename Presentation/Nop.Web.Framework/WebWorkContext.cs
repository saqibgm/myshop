...
namespace Nop.Web.Framework
{
    ...
    public partial class WebWorkContext : IWorkContext
    {
        ...
        //public virtual bool IsInCustomerRole(this Customer customer,
        ...
        //public virtual bool IsAdministrator(this Customer customer, bool onlyActiveCustomerRoles = true)
        //{
        //    return IsInCustomerRole(customer, NopCustomerDefaults.AdministratorsRoleName, onlyActiveCustomerRoles);
        //}

        //public virtual bool IsSaleman(this Customer customer, bool onlyActiveCustomerRoles = true)
        //{
        //    return IsInCustomerRole(customer, NopCustomerDefaults.SalemanRoleName, onlyActiveCustomerRoles);
        //}

        //public virtual bool IsManager(this Customer customer, bool onlyActiveCustomerRoles = true)
        //{
        //    return IsInCustomerRole(customer, NopCustomerDefaults.ManagerRoleName, onlyActiveCustomerRoles);
        //}
        //public virtual bool IsCustomer(this Customer customer, bool onlyActiveCustomerRoles = true)
        //{
        //    return IsRegistered(customer, onlyActiveCustomerRoles) &&
        //        !IsUnApproved(customer, onlyActiveCustomerRoles) &&
        //        !IsAdministrator(customer, onlyActiveCustomerRoles) &&
        //        !IsManager(customer, onlyActiveCustomerRoles) &&
        //        !IsVendor(customer, onlyActiveCustomerRoles) &&
        //        !IsSaleman(customer, onlyActiveCustomerRoles);
        //}
        //public virtual bool IsForumModerator(this Customer customer, bool onlyActiveCustomerRoles = true)
        //{
        ...
        //public virtual bool IsRegistered(this Customer customer, bool onlyActiveCustomerRoles = true)
        //{
        //    return IsInCustomerRole(customer, NopCustomerDefaults.RegisteredRoleName, onlyActiveCustomerRoles);
        //}
        //public virtual bool IsUnApproved(this Customer customer, bool onlyActiveCustomerRoles = true)
        //{
        //    return IsInCustomerRole(customer, NopCustomerDefaults.IncompleteRoleName, onlyActiveCustomerRoles);
        //}
        ///// <summary>
        ...
        ///// <param name="onlyActiveCustomerRoles">A value indicating whether we should look only in active customer roles</param>
        ///// <returns>Result</returns>
        //public virtual bool IsGuest(this Customer customer, bool onlyActiveCustomerRoles = true)
        //{
        ...
        ///// <param name="onlyActiveCustomerRoles">A value indicating whether we should look only in active customer roles</param>
        ///// <returns>Result</returns>
        //public virtual bool IsVendor(this Customer customer, bool onlyActiveCustomerRoles = true)
        //{
