...
namespace Nop.Web.Areas.Admin.Factories
{
    ...
    public partial interface IReportModelFactory
    {
        ...
        /// <summary>
        /// Prepare Saleman Commission report search model
        /// </summary>
        /// <param name="searchModel">Saleman Commission report search model</param>
        /// <returns>Saleman Commission report search model</returns>
        SalemanCommissionReportSearchModel PrepareSalemanCommissionSearchModel(SalemanCommissionReportSearchModel searchModel);

        /// <summary>
        /// Prepare paged Saleman Commission report list model
        /// </summary>
        /// <param name="searchModel">Saleman Commission report search model</param>
        /// <returns>Saleman Commission report list model</returns>
        SalemanCommissionReportListModel PrepareSalemanCommissionListModel(SalemanCommissionReportSearchModel searchModel);
        ...
        /// <summary>
        /// Prepare Profit report search model
        /// </summary>
        /// <param name="searchModel">Profit report search model</param>
        /// <returns>Profit report search model</returns>
        ProfitReportSearchModel PrepareProfitSearchModel(ProfitReportSearchModel searchModel);
        /// <summary>
        /// Prepare Profit report search model
        /// </summary>
        /// <param name="PrepareSalemanStatisticsList">Saleman Statistics Report</param>
        /// <returns>Profit report search model</returns>
        CustomerProfileListModel PrepareSalemanStatisticsList(CustomerProfileSearchModel profileModel);

        /// <summary>
        /// Prepare paged Profit report list model
        /// </summary>
        /// <param name="searchModel">Profit report search model</param>
        /// <returns>Profit report list model</returns>
        ProfitReportListModel PrepareProfitListModel(ProfitReportSearchModel searchModel);
