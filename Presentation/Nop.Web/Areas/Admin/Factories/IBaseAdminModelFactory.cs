...
namespace Nop.Web.Areas.Admin.Factories
{
    ...
    public partial interface IBaseAdminModelFactory
    {
        ...
        void PrepareSalesmanCustomers(IList<SelectListItem> items, string role = null, bool withSpecialDefaultItem = true, string defaultItemText = null);
        void PrepareCustomers(IList<SelectListItem> items, string role = null, bool withSpecialDefaultItem = true, string defaultItemText = null);
        /// <summary>
        ...
        /// <param name="withSpecialDefaultItem">Whether to insert the first special item for the default value</param>
        /// <param name="defaultItemText">Default item text; pass null to use default value of the default item text</param>
        void PrepareCustomersWRTRole(IList<SelectListItem> items, string role = null, bool withSpecialDefaultItem = true, string defaultItemText = null);
        ...
        /// <param name="withSpecialDefaultItem">Whether to insert the first special item for the default value</param>
        /// <param name="defaultItemText">Default item text; pass null to use default value of the default item text</param>
        void PrepareCustomersWRTRoleQuickOrder(IList<CustomerSalemanListItem> items, string needCustomersWithRole = null, int CurrentUserId = 0, int orderCustomerId = 0,  string defaultItemText = null);
