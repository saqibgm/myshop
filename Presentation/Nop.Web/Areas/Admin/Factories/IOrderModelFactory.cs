...
namespace Nop.Web.Areas.Admin.Factories
{
    ...
    public partial interface IOrderModelFactory
    {
        ...
        /// </summary>
        /// <param name="model">Quick Order model</param>
        /// <param name="order">Order</param>
        /// <param name="excludeProperties">Whether to exclude populating of some properties of model</param>
        /// <returns>Order model</returns>
        OrderModel PrepareQuickOrderModel(OrderModel model, Order order, bool excludeProperties = false);

        /// <summary>
        /// Prepare New Quick order model
        /// </summary>
        /// <param name="model">Quick Order model</param>
        /// <param name="order">Order</param>
        /// <param name="excludeProperties">Whether to exclude populating of some properties of model</param>
        /// <returns>Order model</returns>
        OrderModel PrepareNewQuickOrderModel(OrderModel model, bool excludeProperties = false);
