...
namespace Nop.Web.Areas.Admin.Factories
{
    ...
    public partial interface ICustomerModelFactory
    {
        ...
        //CustomerProfileModel PrepareCustomerProfileModel(CustomerProfileModel searchModel);
        ...
        /// <param name="searchModel">Customer search model</param>
        /// <returns>Customer list model</returns>
        CustomerCommissionListModel PrepareSalemanCommissionListModel(CustomerCommissionSearchModel searchModel, Customer customer);
