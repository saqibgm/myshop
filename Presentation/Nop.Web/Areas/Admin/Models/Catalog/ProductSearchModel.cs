...
namespace Nop.Web.Areas.Admin.Models.Catalog
{
    ...
    public partial class ProductSearchModel : BaseSearchModel
    {
        ...
        public ProductSearchModel()
        {
            ...
            AvailableNewStockComingOptions = new List<SelectListItem>();
        }

        #endregion

        #region Properties
        [NopResourceDisplayName("Admin.Catalog.Products.List.SearchArticleNo")]
        public string SearchArticleNo { get; set; }
        ...
        [NopResourceDisplayName("Admin.Catalog.Products.List.SearchCategory")]
        public IList<int> SearchCategoryIds { get; set; }
        ...
        [NopResourceDisplayName("Admin.Catalog.Products.List.SearchNewStockComing")]
        public int SearchNewStockComingId { get; set; }
        ...
        public IList<SelectListItem> AvailableNewStockComingOptions { get; set; }
