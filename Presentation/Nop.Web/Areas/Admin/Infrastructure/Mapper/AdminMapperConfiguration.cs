    ...
    public class AdminMapperConfiguration : Profile, IOrderedMapperProfile
    {
        ...
        protected virtual void CreateCustomersMaps()
        {
            ...
            CreateMap<Customer, CustomerModel>()
                ...
                .ForMember(model => model.CustomerCommissionSearchModel, options => options.Ignore())
            ...
            CreateMap<CustomerCommission, CustomerCommissionModel>()
                .ForMember(model => model.CommissionMonth, options => options.Ignore())
                .ForMember(model => model.BasicSalary, options => options.Ignore())
                .ForMember(model => model.CommissionPercentage, options => options.Ignore())
                .ForMember(model => model.CommissionMinTargert, options => options.Ignore())
                .ForMember(model => model.TotalOrders, options => options.Ignore())
                .ForMember(model => model.TotalSale, options => options.Ignore())
                .ForMember(model => model.TotalProfit, options => options.Ignore())
                .ForMember(model => model.TotalCommission, options => options.Ignore())
                .ForMember(model => model.TotalSale, options => options.Ignore())
                .ForMember(model => model.CreatedOnUtc, options => options.Ignore())
                .ForMember(model => model.LastActivityDateUtc, options => options.Ignore())
                .ForMember(model => model.Active, options => options.Ignore())
                .ForMember(model => model.Deleted, options => options.Ignore());

            CreateMap<CustomerCommissionModel, CustomerCommission>()
                .ForMember(model => model.CommissionMonth, options => options.Ignore())
                .ForMember(model => model.BasicSalary, options => options.Ignore())
                .ForMember(model => model.CommissionPercentage, options => options.Ignore())
                .ForMember(model => model.CommissionMinTargert, options => options.Ignore())
