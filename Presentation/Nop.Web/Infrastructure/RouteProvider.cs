...
namespace Nop.Web.Infrastructure
{
    ...
    public partial class RouteProvider : IRouteProvider
    {
        ...
        public void RegisterRoutes(IRouteBuilder routeBuilder)
        {
            ...
            routeBuilder.MapLocalizedRoute("CustomerContactInfo", "customer/contactinfo",
                new { controller = "Customer", action = "ContactInfo" });


            routeBuilder.MapLocalizedRoute("CustomerProducts", "customer/products",
                new { controller = "Customer", action = "CustomerProducts" });

            routeBuilder.MapLocalizedRoute("CustomerAvatar", "customer/avatar",
				new { controller = "Customer", action = "Avatar" });

            routeBuilder.MapLocalizedRoute("CustomerBusinessCert", "customer/businesscert",
                new { controller = "Customer", action = "BusinessCert" });
