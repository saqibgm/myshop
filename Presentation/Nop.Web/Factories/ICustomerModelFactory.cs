...
namespace Nop.Web.Factories
{
    ...
    public partial interface ICustomerModelFactory
    {
        ...
        CustomerProducts PrepareCustomerProductListModel();
        /// <summary>
        ...
        CustomerProfileSearchModel PrepareCustomerProfileModel(CustomerProfileSearchModel searchModel);
        ...
        /// <summary>
        /// Prepare the customer business cert model
        /// </summary>
        /// <param name="model">Customer business cert model</param>
        /// <returns>Customer business cert model</returns>
        CustomerBusinessCertModel PrepareCustomerBusinessCertModel(CustomerBusinessCertModel model);
